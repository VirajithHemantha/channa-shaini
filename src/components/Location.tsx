...
export const Location: React.FC = () => {
  const venueAddress = "Opulent River Face Hotel, Sri Lanka";
  const mapUrl = `https://maps.google.com/maps?q=Opulent%20River%20face%20hotel&t=&z=13&ie=UTF8&iwloc=&output=embed`;
  const liveLocationUrl = "https://maps.app.goo.gl/aXAcm7t6mwjM4cLMA?g_st=iw";
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-0 mt-10">
          ...
          <div className="bg-white/90 backdrop-blur-2xl p-10 sm:p-14 lg:p-16 rounded-[2.5rem] shadow-[0_30px_60px_rgba(251,113,133,0.15)] border border-brand-sakura/30 lg:translate-x-12 relative overflow-hidden group">
            ...
            <div className="mb-10 relative z-10">
              ...
              <div className="flex items-start gap-5 mt-10">
                ...
                <div>
                  <p className="text-2xl font-sans font-bold text-stone-800 mb-1">Opulent River Face Hotel</p>
                  <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-stone-400 leading-relaxed mb-6">Sri Lanka</p>
        ...
        >
          ...
          <div className="w-full h-full rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-[8px] sm:border-[12px] border-white relative group/map">
            ...
            <iframe
              title="Opulent River Face Hotel Location"
              src={mapUrl}
              width="100%"
              height="100%"
