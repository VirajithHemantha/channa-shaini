...
export default function App() {
  ...
  const weddingDate = new Date('2026-12-10T09:30:00');
      ...
      <AnimatePresence mode="wait">
        {!showMain ? (
          ...
          >
            ...
            <section id="countdown" className="py-20 sm:py-32 relative overflow-hidden bg-brand-champagne/30">
            ...
            <section id="ceremony" className="pt-16 pb-16 sm:pt-32 sm:pb-32 bg-brand-ivory overflow-hidden">
              <CeremonyDetails />
            </section>
